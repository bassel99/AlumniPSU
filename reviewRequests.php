    ...
    <div class="modal-content">
        ...
        <form action="Sign_up.php" method="POST">
            ...
            <div class="modal-body">
                <center><h1>Reviwe registred Alumnu</h1></center>

                <div class="form-group">Arabic Name
                    <input type="text" value="<?php echo $row['Arabic_name']; ?>" class="form-control input-lg"
                ...
                <div class="form-group">Email
                    <input type="email" value="<?php echo $row['Arabic_name']; ?>" class="form-control input-lg"
                           placeholder="Email" name="Email"/>
                </div>

                <div class="form-group">
                    <input type="submit" value="<?php echo $row['Arabic_name']; ?>" name="submit"
